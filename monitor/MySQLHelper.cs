...
namespace MySQLHelper
{
    ...
    public class MySqlHelper
    {
        ...
        //private string connstr = @"Host=127.0.0.1;UserName=root;Password=drpassword;Database=watermonitor;Port=3406;CharSet=utf8;Allow Zero Datetime=true";
        private static string act_connstr;
        ...
        {
            MySqlConnection connection = new MySqlConnection(act_connstr);
        ...
        {
            using (MySqlConnection conn = new MySqlConnection(act_connstr))
            {
        ...
        {
            using (MySqlConnection connection = new MySqlConnection(act_connstr))
            {
